...
{
    public partial class iBuffEdit : Form
    {
        ...
        public iBuffEdit(string _objName, Data _dataObj)
        {
            InitializeComponent();
            dataObj = _dataObj;
            objName = _objName;
        ...
        public iBuffEdit(string _objName, Data _dataObj, int _keyno)
        {
            InitializeComponent();
            dataObj = _dataObj;
            objName = _objName;
        ...
        private void iBuffEdit_Load(object sender, EventArgs e)
        {
            cmbKey.Items.Clear();
