...
{
    public partial class potEdit : Form
    {
        ...
        public potEdit(string _objName, Data _dataObj)
        {
            InitializeComponent();
            dataObj = _dataObj;
            objName = _objName;
        ...
        public potEdit(string _objName, Data _dataObj, int _keyno)
        {
            InitializeComponent();
            dataObj = _dataObj;
            objName = _objName;
        ...
        private void potEdit_Load(object sender, EventArgs e)
        {
            cmbKey.Items.Clear();
